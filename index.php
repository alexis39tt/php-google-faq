...
function QandAs($faqs){
    foreach($faqs as $key1 => $value1){
        foreach($faqs[$key1] as $key2 => $value2){
            if($key2 == 'question'){
                echo '<h2>'.$value2.'</h2>';
            }
            else{
    ...
    <div id="root">
        <div class="navbar">
            ...
            <div class="bottom">
                ...
                <a>Tecnologie</a>
                <a class="selected">Domande frequenti</a>
            </div>
        </div>
        <div class="text">
            <?php QandAs($faqs) ?>
